...
class file_info_2d_data:
    def __init__(self, real_weight, real_bias, full_loss_f=[], dots_count=100, variance=1, labels_loss=[],
                 current_random_generator=random_generator):
        self.real_weight = real_weight
        self.real_bias = real_bias
        self.X, self.y = current_random_generator([real_weight], real_bias, dots_count, variance)
        self.loss_f = []
